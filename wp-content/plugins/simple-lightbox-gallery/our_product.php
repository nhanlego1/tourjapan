		...
		<div class="section container">
			...
			<div class="col-lg-6">
				...
				<ol id="weblizar_product">
					...
					<li><a href="https://weblizar.com/plugins/photo-video-link-gallery-pro/"><?php _e('Photo Video Link Gallery Pro','weblizar'); ?> </a> </li>
					<li><a href="http://weblizar.com/plugins/responsive-portfolio-pro/"><?php _e('Responsive Portfolio Pro','weblizar'); ?> </a> </li>
					<li><a href="http://weblizar.com/lightbox-slider-pro/"><?php _e('Lightbox Slider Pro','weblizar'); ?> </a> </li>
					<li><a href="http://weblizar.com/plugins/flickr-album-gallery-pro/"><?php _e('Flickr Album Gallery Pro','weblizar'); ?> </a> </li>
					<li><a href="https://weblizar.com/plugins/instagram-shortcode-and-widget-pro/"><?php _e('Instagram Shortcode & Widget Pro','weblizar'); ?> </a> </li>
					<li><a href="https://weblizar.com/plugins/instagram-gallery-pro/"><?php _e('Instagram Gallery Pro','weblizar'); ?> </a> </li>
					<li><a href="https://weblizar.com/plugins/responsive-photo-gallery-pro/"><?php _e('Responsive Photo Gallery Pro','weblizar'); ?> </a> </li>
				</ol>
			</div>
		</div>	
