...
= WordPress Notice =
* Plugin should work with WordPress 4.0 and 4.1, but these versions are no longer used for testing, and they are no longer supported.
...
== Upgrade Notice ==
= 2.1 =
Many more new filters. Improvements to rating method. Many other updates and improvements. Many bugs fixed.
