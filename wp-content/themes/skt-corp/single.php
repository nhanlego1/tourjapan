                ...
                <div class="courseArchive_content">
                 ...
                 <img alt="img"
                    ...
                    <div class="single_course_content">
                        ...
                        <div class="host-desc">
                            <p>案内エリア : <?php echo get_post_meta($post->ID, 'guide_area', TRUE) ?></p>
                            <p>対応言語：<?php echo get_post_meta($post->ID, 'host_tour_language', TRUE) ?></p>
                            <p>移動手段：<?php echo get_post_meta($post->ID, 'transportration', TRUE) ?></p>
