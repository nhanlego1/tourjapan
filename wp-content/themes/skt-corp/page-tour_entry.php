                        ...
                        <form action="<?php echo esc_url(home_url('/')); ?>tour_entry/" method="post">
                            <fieldset>
                                ...
                                <input type="hidden" name="paypal_account"
                                       value="<?php echo $_POST['paypal_account']; ?>">
                            ...
                            <fieldset>
                                ...
                                <fieldset>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <th>ツアータイトル<em class="required">※</em></th>
                                            <td><input id="t5nm" required maxlength="300" name="t5nm" size="60"
                                                       type="text"
                                                       value=""/></td>
                                        </tr>
                                        <tr>
                                            <th>Paypal Account<em class="required">※</em></th>
                                            <td><input id="t5nm" required maxlength="300" name="paypal_account"
                                                       size="60" type="text"
                                                       value=""/></td>
                                        </tr>
                                        <tr>
...
<label for="c5kv6"><input id="c5kv6" name="c5kv[]" type="checkbox" value="体験"/>体験</label>
                                        ...
                                        <tr>
                                            <th>ツアー概要・ＰＲ<em class="required">※</em></th>
                                            <td><textarea id="t0ym" required cols="60" name="t0ym" rows="6"></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>ツアースケジュールイメージ<em class="required">※</em></th>
                                            <td><textarea id="t1lr" cols="60" required name="t1lr" rows="6"></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>出発地<em class="required">※</em></th>
                                            <td><input id="t0gb" maxlength="300" name="t0gb" size="60" required
                                                       type="text"
                                                       value=""/></td>
                                        </tr>
                                        <tr>
                                            <th>対象年齢<em class="required">※</em></th>
                                            <td><input id="t6en" maxlength="300" name="t6en" size="60" required
                                                       type="text"
                                                       value=""/></td>
                                        </tr>
                                        <tr>
                                            <th>ツアー料金<em class="required">※</em></th>
                                            <td><input id="t8sb" maxlength="300" name="t8sb" size="60" required
                                                       type="text"
                                                       value=""/></td>
                                        </tr>
                                        <tr>
                                            <th>料金に含まれるもの<em class="required">※</em></th>
                                            <td><textarea id="t3ic" required cols="60" name="t3ic" rows="6"></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>所要時間<em class="required">※</em></th>
                                            <td><input id="t2xk" maxlength="300" required name="t2xk" size="60"
                                                       type="text"
                                                       value=""/></td>
                                        </tr>
                                        <tr>
                                            <th>対応言語<em class="required">※</em></th>
                                            <td><input id="t6ki" maxlength="300" name="t6ki" required size="60"
                                                       type="text"
                                                       value=""/></td>
                                        </tr>
                                        <tr>
                                            <th>食事の有無<em class="required">※</em></th>
                                            <td><input id="t5gn" maxlength="300" name="t5gn" required size="60"
                                                       type="text"
                                                       value=""/></td>
                                        </tr>
                                        <tr>
                                            <th>送迎の有無<em class="required">※</em></th>
                                            <td><input id="t0fd" maxlength="300" name="t0fd" required size="60"
                                                       type="text"
                                                       value=""/></td>
                                        </tr>
                                        <tr>
                                            <th>開催曜日<em class="required">※</em></th>
                                            <td><input id="t0mi" maxlength="300" name="t0mi" required size="60"
                                                       type="text"
                                                       value=""/></td>
                                        </tr>
                                        <tr>
                                            <th>最少遂行人数<em class="required">※</em></th>
                                            <td><input id="t5lx" maxlength="300" name="t5lx" size="60" required
                                                       type="text"
                                                       value=""/></td>
                                        </tr>
                                        <tr>
                                            <th>注意事項<em class="required">※</em></th>
                                            <td><textarea id="t7ex" cols="60" name="t7ex" required rows="6"></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>備考<em class="required">※</em></th>
                                            <td><textarea id="t4ti" cols="60" required name="t4ti" rows="6"></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>お問い合わせ先＜会社名・団体名＞<em class="required">※</em></th>
                                            <td><input id="t0zz" maxlength="300" required name="t0zz" size="60"
                                                       type="text"
                                                       value=""/></td>
                                        </tr>
                                        <tr>
                                            <th>ご担当者名<em class="required">※</em></th>
                                            <td><input id="t8ro" maxlength="300" name="t8ro" required size="60"
                                                       type="text"
                                                       value=""/></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><span class="lside">郵便番号</span><input id="t5kf" required maxlength="3"
                                                ...
                                                <span class="lside">市区町村</span><input id="t4bf" maxlength="300"
                                                                                      name="t4bf"
                                                                                      required size="60" type="text"
                                                                                      value=""/>
                                                <span class="lside">番地建物</span><input id="t1yt" maxlength="300"
                                                                                      name="t1yt"
                                                                                      required size="60" type="text"
                                                                                      value=""/></td>
                                        </tr>
                                        <tr>
                                            <th>電話番号<em class="required">※</em></th>
                                            <td><input id="t4my" maxlength="300" name="t4my" size="60" required
                                                       type="text"
                                                       value=""/>
                                        ...
                                        <tr>
                                            <th>メールアドレス<em class="required">※</em></th>
                                            <td><input id="t0qm" maxlength="300" name="t0qm" size="60" type="text"
                                                       required
                                                       value=""/>
