                    ...
                    <ul class="progress-indicator">
                        ...
                        while ($wp_query->have_posts()):
                            ...
                            <li class="<?php if ($step >= 3): ?>completed<?php endif; ?>">
                                ...
                                <span class="title-step"><?php echo get_post_meta(get_the_ID(), 'step4', TRUE);
                                    ?></span>
                            </li>
                ...
                <div class="tab-pane active" id="tab1" style="background: url(../bg-container.jpg);">
                    ...
                    <div class="container" style="/*max-width:769px;*/" id="wrap-host">
                        ...
                        <div id="mainform">
                            <p></p>
                            <br/>
                            <h2 class="text-center"><a href="/">ホストになる（通訳ガイド）エントリーフォーム</a>
                            </h2>
                                            ...
                                            <div id="mainform">
                                                ...
                                                <div>
                                                    <ul>
                                                        ...
                                                        <li>1週間後の12月24日（土曜日）になっても返信されない場合は届いていない可能性がありますので、再度送信して下さい。
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                    ...
                    <?php if (isset($_POST['to_step_3']) and $_POST['to_step_3'] == 'yes'): ?>
                        ...
                        $content .='<table class="table table-striped course_table">
                            <thead>
                            <tr>
                                <th colspan="3" style="border: 1px solid #d4d2d2; color: #333;"><h2><span class="fa fa-quote-left"></span>　私の案内するお勧めグルメ！！</h2>
                                </th>
                            </tr>
                            </thead>
                            <tbody>
                        ...
                        $content .='<table class="table table-striped course_table">
                            <thead>
                            <tr>
                                <th colspan="3" style="border: 1px solid #d4d2d2; color: #333;"><h2><span class="fa fa-quote-left"></span>　私の案内するお勧めスポット！！</h2>
                                </th>
                            </tr>
                            </thead>
                            <tbody>
                        ...
                        $content .='<table class="table table-striped course_table">
                            ...
                            <tr>
                                <td><font><font>案内エリア</font></font></td>
                                <td><font><font>'.$guide_area.'</font></font></td>
                            </tr>
                            <tr>
                                <td><font><font>対応言語</font></font></td>
                                <td><font><font>'.$_POST['t7pj'].'</font></font></td>
                            </tr>
                            <tr>
                                <td><font><font>最低時間</font></font></td>
                                <td><font><font>'.$_POST['t9ag'].'</font></font></td>
                            </tr>
                            <tr>
                                <td><font><font>移動手段</font></font></td>
                                <td><font><font>'.implode(', ',$_POST['c9lr']).'</font></font></td>
                            </tr>
                            <tr>
                                <td><font><font>車の提供可能</font></font></td>
                                <td><font><font>-</font></font></td>
                            </tr>
                            <tr>
                                <td><font><font>基本時間</font></font></td>
                                <td><font><font>'.$_POST['t4jy'].'</font></font></td>
                            </tr>
                            <tr>
                                <td><font><font>朝早／夜遅</font></font></td>
                                <td><font><font>'.$_POST['t9su'].'</font></font>
                                </td>
                            </tr>
                            <tr>
                                <td><font><font>専門</font></font></td>
                                <td><font><font>-</font></font></td>
                            </tr>
                            <tr>
                                <td><font><font>年齢</font></font></td>
                                <td><font><font>-</font></font></td>
                            </tr>
                            <tr>
                                <td><font><font>現在の仕事</font></font></td>
                                <td><font><font>-</font></font></td>
                            </tr>
                            </tbody>
                        </table>';
                        ...
                        <form action="<?php echo esc_url(home_url('/')); ?>host_entry/" method="post">
                            <fieldset>
                                ...
                                <table summary="確認内容">
                                    ...
                                    <tr>
                                        <th>PayPalアカウント<em class="required">※</em></th>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            年<?php echo $_POST['t9ip']; ?>月<?php echo $_POST['t3xl']; ?>日
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <fieldset>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <th>お名前<em class="required">※</em></th>
                                            <td>
                                                <input type="text" id="t3di" name="t3di" size="60" value=""
                                                       maxlength="300"
                                                       required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>アバター<em class="required">※</em></th>
                                            <td>

                                                <input type="file" id="avatar" name="avatar" size="60" required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>PayPalアカウント<em class="required">※</em></th>
                                            <td>
                                                <input type="text" id="paypal_account" name="paypal_account" size="60" value=""
                                                       maxlength="300"
                                                       required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>名前（ローマ字）</th>
                                            <td>
                                                <input type="text" id="t2wv" name="t2wv" size="60" value=""
                                                       maxlength="300">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>住所<em class="required">※</em></th>
                                            <td>
                                                <span class="lside">郵便番号</span><input type="number" required
                                                                                      maxlength="3"
                                                                                      id="t3gq" name="t3gq"
                                                                                      style="height:25px" size="3"
                                                                                      value=""
                                                                                      oninput="maxLengthCheck3(this)"
                                                                                      max="999"><span
                                                    class="rside">-</span><input
                                                    type="number" maxlength="4" required id="t0sz"
                                                    oninput="maxLengthCheck4(this)" name="t0sz" style="height:25px"
                                                    size="4"
                                                    value="" max="9999"><br>
                                                ...
                                                <span class="lside">市区町村</span><input type="text" id="t4ii" name="t4ii"
                                                                                      size="60" value="" maxlength="300"
                                                                                      required><br>
                                                <span class="lside">番地建物</span><input type="text" id="t0pi" name="t0pi"
                                                                                      size="60" value="" maxlength="300"
                                                                                      required>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><span class="aside">※サイトには○○才～○○才と5才単位で表示されます。</span><br>
                                                ...
                                                </select><select style="float:left" aria-label="年" name="t2ne" id="t2ne"
                                                                 title="年" class="_5dba hidden" aria-controls="js_iq"
                                                                 aria-haspopup="true" role="null"
                                                                 aria-describedby="js_ko">
                                                    <option value="0" selected="1">年</option>
                                                ...
                                                </select><select style="float:left" required aria-label="月" name="t9ip"
                                                                 id="t9ip" title="月" class="_5dba">
                                                    <option value="0" selected="1">月</option>
                                                ...
                                                </select><select style="float:left" required aria-label="日" name="t3xl"
                                                                 id="t3xl" title="日" class="_5dba">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="tel" required id="t0fl" name="t0fl" style="height:25px"
                                                       size="60" value="" maxlength="11"><br>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" required id="t7pj" name="t7pj" size="60" value=""
                                                       maxlength="300">
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <th>メールアドレス<em class="required">※</em></th>
                                            <td>
                                                <input type="email" required id="t9hg" name="t9hg" style="height:25px"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" required id="t4jy" name="t4jy" size="60" value=""
                                                       maxlength="300">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" required id="t9ag" name="t9ag" size="60" value=""
                                                       maxlength="300">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>最低ガイド時間の時給<em class="required">※</em></th>
                                            <td>
                                                <input type="text" required id="t8nd" name="t8nd" size="60" value=""
                                                       maxlength="300">
                                            </td>
                                        </tr>
                                        <tr>
                                    ...
                                    <span id="c9oq" class="checkbox">
                                      <label for="c9oq0"><input type="checkbox" id="c9oq0" name="c9oq[]" value="朝早　OK">朝早　OK</label><label
                                            for="c9oq1"><input type="checkbox" id="c9oq1" name="c9oq[]" value="朝早　NG">朝早　NG</label><label
                                            for="c9oq2"><input type="checkbox" id="c9oq2" name="c9oq[]" value="夜遅　OK">夜遅　OK</label><label
                                            for="c9oq3"><input type="checkbox" id="c9oq3" name="c9oq[]" value="夜遅　NG">夜遅　NG</label>
                                    </span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>朝早／夜遅の際の時給</th>
                                            <td>
                                                <input type="text" id="t9su" name="t9su" size="60" value=""
                                                       maxlength="300">
                                            </td>
                                        </tr>
                                        <tr>
                                    ...
                                    <span id="c9lr" class="checkbox">
                                      ...
                                      <label for="c9lr1"><input type="checkbox" id="c9lr1" name="c9lr[]"
                                                                value="車（レンタカー）">車（レンタカー）</label>
                                      <label for="c9lr2"><input type="checkbox" id="c9lr2" name="c9lr[]"
                                                                value="電車">電車</label>
                                      <label for="c9lr3"><input type="checkbox" id="c9lr3" name="c9lr[]"
                                                                value="バス">バス</label>
                                      <label for="c9lr4"><input type="checkbox" id="c9lr4" name="c9lr[]"
                                                                value="徒歩">徒歩</label>
                                      <label for="c9lr5"><input type="checkbox" id="c9lr5" name="c9lr[]" value="その他">その他</label>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" id="t4qr" name="t4qr" size="60" value=""
                                                       maxlength="300">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="file" id="f6et" name="f6et" size="60" required><br><span
                                                    class="aside">スポット名①</span><br><input type="text" id="t8kg" required
                                                                                          name="t8kg" size="60" value=""
                                                                                          maxlength="300"><br>

                                                <input type="file" id="f6rs" name="f6rs" size="60"><br><span
                                                    class="aside">スポット名②</span><br><input
                                                    type="text" id="t5ue" name="t5ue" size="60" value=""
                                                    maxlength="300"><br>

                                                <input type="file" id="f6hl" name="f6hl" size="60"><br> <span
                                                    class="aside">スポット名③</span><br><input
                                                    type="text" id="t5wp" name="t5wp" size="60" value=""
                                                    maxlength="300">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="file" id="f5ue" name="f5ue" size="60" required><br><span
                                                    class="aside">例）お勧めグルメ名／○○屋の○○ラーメン、○○店の○○丼、等</span><br><input
                                                    type="text" id="t4gt" name="t4gt" required size="60" value=""
                                                    maxlength="300"><br>
                                                <input type="file" id="f5vi" name="f5vi" size="60"><br><span
                                                    class="aside">例）お勧めグルメ名／○○屋の○○ラーメン、○○店の○○丼、等</span><br><input
                                                    type="text" id="t0zf" name="t0zf" size="60" value=""
                                                    maxlength="300"><br>
                                                <input type="file" id="f9gp" name="f9gp" size="60"><br><span
                                                    class="aside">例）お勧めグルメ名／○○屋の○○ラーメン、○○店の○○丼、等</span><br><input
                                                    type="text" id="t8ia" name="t8ia" size="60" value=""
                                                    maxlength="300">
                                            </td>
                                        </tr>
                                        </tbody>
