...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'skt-corp' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'skt-corp' ),
		'repeat-y'  => __( 'Repeat Vertically', 'skt-corp' ),
		'repeat'    => __( 'Repeat All', 'skt-corp' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'skt-corp' ),
		'top center'    => __( 'Top Center', 'skt-corp' ),
		'top right'     => __( 'Top Right', 'skt-corp' ),
		'center left'   => __( 'Middle Left', 'skt-corp' ),
		'center center' => __( 'Middle Center', 'skt-corp' ),
		'center right'  => __( 'Middle Right', 'skt-corp' ),
		'bottom left'   => __( 'Bottom Left', 'skt-corp' ),
		'bottom center' => __( 'Bottom Center', 'skt-corp' ),
		'bottom right'  => __( 'Bottom Right', 'skt-corp')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'skt-corp' ),
		'fixed'  => __( 'Fixed in Place', 'skt-corp')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'skt-corp' ),
		'italic'      => __( 'Italic', 'skt-corp' ),
		'bold'        => __( 'Bold', 'skt-corp' ),
		'bold italic' => __( 'Bold Italic', 'skt-corp' )
		);
