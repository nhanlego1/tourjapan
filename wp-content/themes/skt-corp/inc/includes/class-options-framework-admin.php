...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => __( 'Theme Options', 'skt-corp' ),
			'menu_title' => __( 'Theme Options', 'skt-corp' ),
			'capability' => 'edit_theme_options',
			'menu_slug' => 'sktcorp-options',
     ...
     */
	 function options_page() { ?>
	    ...
	    <h2 class="nav-tab-wrapper">
          ...
          <div style="padding-top:10px;font-size:15px;"><a href="<?php echo esc_url(SKT_THEME_URL_DIRECT); ?>" target="_blank"><?php _e('Buy PRO version for only $39 with more features.','skt-corp'); ?></a></div>
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox"  style="width:72%; float:left;">
				...
				<div id="optionsframework-submit">
					<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', 'skt-corp' ); ?>" />
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'skt-corp' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'skt-corp' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
            ...
            <div class="meta-box-sortables ui-sortable">
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        <p><em>For support email us at <strong><a href="mailto:support@sktthemes.com">support@sktthemes.com</a></strong></em></p>
                    </div>
                </div>
	...
	function validate_options( $input ) {
		...
		if ( isset( $_POST['reset'] ) ) {
			add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', 'skt-corp' ), 'updated fade' );
	...
	function save_options_notice() {
		add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', 'skt-corp' ), 'updated fade' );
	}
